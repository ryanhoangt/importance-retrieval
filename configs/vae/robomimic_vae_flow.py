...
from openx.data.datasets.robomimic import robomimic_flow_dataset_transform
    ...
    dataloader = dict(
        datasets=dict(
            square_400_paired=dict(
                path="PATH_TO/square_400_paired_flow/1.0.0",
                train_split="train",
                val_split="val",
                transform=ModuleSpec.create(robomimic_flow_dataset_transform),
            ),
        ),
